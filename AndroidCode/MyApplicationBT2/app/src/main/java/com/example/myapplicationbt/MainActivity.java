...
public class MainActivity extends AppCompatActivity implements ConnectedThread.OnDataReceivedListener{
    ...
    private boolean shouldSendData1 = false;
    private boolean shouldSendData2 = false;
    private boolean shouldSendData3 = false;
...
//        full_6.setOnClickListener(view -> setFullBackground(6));
        // 在初始化 servor 按钮的地方添加如下代码
servor_1.setOnClickListener(view -> {
    shouldSendData1 = true;
    setServorBackground(1);
});
        servor_2.setOnClickListener(view -> {
            shouldSendData1 = true;
            setServorBackground(2);
        });
        servor_3.setOnClickListener(view -> {
            shouldSendData1 = true;
            setServorBackground(3);
        });
        servor_4.setOnClickListener(view -> {
            shouldSendData1 = true;
            setServorBackground(4);
        });
        servor_5.setOnClickListener(view -> {
            shouldSendData1 = true;
            setServorBackground(5);
        });
        servor_6.setOnClickListener(view -> {
            shouldSendData1 = true;
            setServorBackground(6);
        });
        weight_1.setOnClickListener(view -> {
            shouldSendData2 = true;
            setWeightBackground(1);
        });
        weight_2.setOnClickListener(view -> {
            shouldSendData2 = true;
            setWeightBackground(2);
        });
        weight_3.setOnClickListener(view -> {
            shouldSendData2 = true;
            setWeightBackground(3);
        });
        weight_4.setOnClickListener(view -> {
            shouldSendData2 = true;
            setWeightBackground(4);
        });
        weight_5.setOnClickListener(view -> {
            shouldSendData2 = true;
            setWeightBackground(5);
        });
        weight_6.setOnClickListener(view -> {
            shouldSendData2 = true;
            setWeightBackground(6);
        });
        full_1.setOnClickListener(view -> {
            shouldSendData3 = true;
            setFullBackground(1);
        });

        full_2.setOnClickListener(view -> {
            shouldSendData3 = true;
            setFullBackground(2);
        });
        full_3.setOnClickListener(view -> {
            shouldSendData3 = true;
            setFullBackground(3);
        });
        full_4.setOnClickListener(view -> {
            shouldSendData3 = true;
            setFullBackground(4);
        });
        full_5.setOnClickListener(view -> {
            shouldSendData3 = true;
            setFullBackground(5);
        });
        full_6.setOnClickListener(view -> {
            shouldSendData3 = true;
            setFullBackground(6);
        });
...
//        bluetooth_name.setText(BluetoothActivity.bleetoothName!=null?BluetoothActivity.bleetoothName:"未连接");
     ...
     */
    private void setServorBackground2(int color) {
        servor_color = color;
     ...
     */
    private void setWeightBackground2(int color) {
        weight_color = color;
...
private void setWeightBackground(int color) {
    ...
    // 仅当 shouldSendData 为 true 时才发送数据
    if (shouldSendData2) {
        StringBuilder hexDataBuilder = new StringBuilder();
        hexDataBuilder.append(HEX_DATA_PER)
                .append(HEX_DATA_WEIGHT)
     ...
     */
    private void setFullBackground2(int color) {
        full_color = color;
